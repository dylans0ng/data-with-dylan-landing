...
export function buildAccountWelcomeEmail(publicSiteUrl) {
  ...
  const text = [
    "Hi there,",
    "",
    "You're all set—your Data with Dylan account was created successfully.",
    "",
          ...
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:600px;background:#ffffff;border:1px solid #ded8cc;border-radius:16px;">
            <tr>
              <td style="padding:40px 36px;">
                ...
                <p style="margin:0 0 18px;font-size:17px;line-height:1.6;">You’re all set—your Data with Dylan account was created successfully.</p>
                ...
                <p style="margin:0;font-size:17px;line-height:1.6;">Happy learning,<br>Dylan<br>Data with Dylan</p>
              </td>
            </tr>
            <tr>
